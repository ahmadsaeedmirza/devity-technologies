...
featuredImage:
  ...
  alt: "A simple horizontal bar chart showing three project tiers (small tool, mid-size platform, enterprise system) with GBP cost ranges, in the site's teal/mint/ink brand colors"
