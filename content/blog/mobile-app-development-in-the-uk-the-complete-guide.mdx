...
featuredImage:
  ...
  alt: "A phone mockup showing a clean app interface, with a subtle split showing the same interface rendered on both iOS and Android style chrome, in the site's teal/mint/ink brand colors, no stock-photo people"
