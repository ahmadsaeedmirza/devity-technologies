...
featuredImage:
  ...
  alt: "IMG SUGGESTION: A simple staircase-style diagram showing three ascending steps labeled MVP, Growth, and Scale, each with a GBP cost range, in the site's teal/mint/ink brand colors"
