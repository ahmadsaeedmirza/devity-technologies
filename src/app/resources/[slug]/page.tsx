...
export default async function Page({
  ...
  const frontmatter = data as PostFrontmatter;
  const relatedPosts = getRelatedPosts(frontmatter.category, slug, 3);
    ...
    <>
      ...
      <Layout>
        <article className="container py-24 max-w-3xl mx-auto">
          ...
          <p className="text-foreground-soft text-lg mb-8">
          ...
          {relatedPosts.length > 0 && (
            <div className="mt-20">
              <p className="label-mono mb-6">Read next</p>
              <h2 className="font-display text-3xl md:text-4xl font-medium leading-[0.98] tracking-tight mb-10">
                More on {frontmatter.category}
              </h2>
              <div className="space-y-px bg-border border border-border">
                {relatedPosts.map((post) => (
                  <a
                    ...
                    className="bg-background p-6 flex flex-col md:flex-row items-start md:items-center gap-6 hover:bg-mint-soft/30 transition-colors group"
                  >
                    {post.featuredImage && (
                      <img
                        ...
                        width={200}
                        height={130}
                        className="w-full md:w-48 h-32 object-cover shrink-0 border border-border"
                      />
                    )}
                    <div>
