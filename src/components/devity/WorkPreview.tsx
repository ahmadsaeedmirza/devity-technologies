...
export const cases = [
  ...
  },
  {
    ...
    color: "bg-ink",
    client: "Tecno Instruments",
    testimonial: "Before Devity, our team was buried in spreadsheets trying to keep 14 warehouses in sync. The automation and forecasting system they built cut our manual work dramatically and gave us visibility we never had before. It's saved our ops team hundreds of hours.",
  },
];
